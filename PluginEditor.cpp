    ...
    , processorRef(p)
{
    ...
    peakButton.setButtonText("peak vs rms");
    peakButton.setClickingTogglesState(true);

        peakButton.onClick = [this]
    {
        if (peakButton.getToggleState())
            processorRef.setLevelMode(LevelMode::Peak);
        else
            processorRef.setLevelMode(LevelMode::RMS);
    };

    // buttonColours
    peakButton.setColour(juce::TextButton::ColourIds::buttonOnColourId,
        juce::Colours::lightgoldenrodyellow);
    peakButton.setColour(juce::TextButton::ColourIds::buttonColourId,
        juce::Colours::crimson);
    peakButton.setColour(juce::TextButton::ColourIds::textColourOnId,
        juce::Colours::blueviolet);
    peakButton.setColour(juce::TextButton::ColourIds::textColourOffId,
        juce::Colours::black);
...
void AudioPluginAudioProcessorEditor::resized()
{
    ...
    peakButton.setBounds(leftMargin, topMargin, buttonWidth, buttonHeight);
